  ...
  return (
    <div className="w-[420px] bg-gray-800/80 rounded-2xl shadow-xl overflow-hidden flex flex-col backdrop-blur-lg border border-gray-700/50 transform hover:scale-105 transition-all duration-300 animate-fade-in-up">
      ...
      <div className="flex justify-between items-center px-6 pb-5 gap-4 mt-auto">
        <button className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white text-sm font-semibold px-6 py-2 rounded-full shadow-md transform hover:scale-110 transition-all duration-200">
          <FaTimes />
          Ignore
        </button>
        <button className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white text-sm font-semibold px-6 py-2 rounded-full shadow-md transform hover:scale-110 transition-all duration-200">
          <FaHeart />
          Interested
        </button>
      </div>
